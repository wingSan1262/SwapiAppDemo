...
public final class SearchViewModel extends androidx.lifecycle.ViewModel {
    ...
    private final androidx.lifecycle.LiveData<com.example.testapplication.base_component.entities.Event<com.example.testapplication.base_component.entities.ResourceState<vanrrtech.app.ajaib_app_sample.domain.data_model.github.response.PeopleListModel>>> searchPeopleLiveData = null;
    private final androidx.lifecycle.LiveData<com.example.testapplication.base_component.entities.Event<com.example.testapplication.base_component.entities.ResourceState<vanrrtech.app.ajaib_app_sample.domain.data_model.github.response.PeopleListModel>>> offlineCachingLiveData = null;
    @org.jetbrains.annotations.NotNull()
    ...
    public final androidx.lifecycle.LiveData<com.example.testapplication.base_component.entities.Event<com.example.testapplication.base_component.entities.ResourceState<vanrrtech.app.ajaib_app_sample.domain.data_model.github.response.PeopleListModel>>> getSearchPeopleLiveData() {
        return null;
    }
    
    public final void searchPeopleData(@org.jetbrains.annotations.NotNull()
    vanrrtech.app.ajaib_app_sample.domain.data_model.github.request.SearchPeopleRequest param) {
    }
    
    public final androidx.lifecycle.LiveData<com.example.testapplication.base_component.entities.Event<com.example.testapplication.base_component.entities.ResourceState<vanrrtech.app.ajaib_app_sample.domain.data_model.github.response.PeopleListModel>>> getOfflineCachingLiveData() {
        return null;
    }
    ...
    java.util.List<vanrrtech.app.ajaib_app_sample.domain.data_model.github.response.PeopleItemResponse> content) {
    }
