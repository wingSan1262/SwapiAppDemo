...
public final class AppModule {
    ...
    @AppScope()
    @dagger.Provides()
    public final com.example.testapplication.data.remote_repository.RemoteApiRetrofitClient getClient(@org.jetbrains.annotations.NotNull()
    ...
    com.example.testapplication.data.remote_repository.RemoteApiRetrofitClient retrofit, @org.jetbrains.annotations.NotNull()
    com.example.testapplication.data.local_db.PeopleItemDao peopleItemDao) {
        return null;
    }
    ...
    @AppScope()
    @dagger.Provides()
    public final com.example.testapplication.data.local_db.LocalDb getUserListDataDB(@org.jetbrains.annotations.NotNull()
    android.app.Application application) {
        return null;
    }
    ...
    @AppScope()
    @dagger.Provides()
    public final com.example.testapplication.data.local_db.PeopleItemDao getUserListDataDBDao(@org.jetbrains.annotations.NotNull()
    com.example.testapplication.data.local_db.LocalDb db) {
        return null;
    }
